...
def robot_control_loop():
    ...
    def set_drive(fwd, steer, pause):
        ...
        if pause == False:
            ...
            for m in left_motors: m.set_speed(0)
            for m in right_motors: m.set_speed(0)
    ...
    try:
        # Run inference
        #results = model(source=1, stream=True, show=False, conf=0.20, imgsz=640, verbose=False)
        cap = None
		...
		f"best_y_x: {best_y_x}",
            ...
            set_drive(BASE_SPEED, steering, motor_pause)
